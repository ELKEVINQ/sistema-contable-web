...
export class PagarRolComponent {
  ...
  imprimirRol(nombres: any, valor: any, fecha: Date, observaciones: any) {
            ...
            columns: [
              ...
              },
              {
                ...
                stack: [
                  'RUC: ' + ruc,
                  {
                    text: 'Fecha de inicio. ' + this.formatearFecha(this.dateToMySQLDate(fecha) + ''),
                    fontSize: 15,
                    bold: true
                  },
                  {
                    text: 'Fecha de pago. ' + this.formatearFecha(this.dateToMySQLDate(fechaActual) + ''),
                    fontSize: 15,
                    bold: true
                  },
                ]
          ...
          //Datos del empleado
          {
            ...
            table: {
              ...
              body: [
                ...
                [
                  { text: 'Cedula/RUC: ' + this.cedula, alignment: 'left' },
                ]
              ]
            }
          },
            ...
            columns: [
              ...
              },
              {
                ...
                table: {
                  ...
                  widths: ['auto', 'auto'],
                  body: [
                    ['Sueldo: ', { text: valor, alignment: 'right' }],
                    ['Anticipos: ', { text: this.anticiposSumados, alignment: 'right' }],
                    ['Recibe: ', { text: (valor - this.anticiposSumados), alignment: 'right' }],
                  ],
                },
              },
            ]
  ...
  onSubmit() {
    if (this.rolForm.valid) {
      ...
      this.registroService.insertarRol({ idEmpleado, valor, anticipo, fechaFormateada, descripcion, observaciones, fechaPago }).subscribe((response: { success: any; }) => {
        if (response.success) {
          alert('Rol de pago insertado correctamente');
          this.imprimirRol(nombres, valor, fecha, observaciones);
